...
function alg_get_current_user_first_role() {
		...
		if ( 'sin-iva' === $current_user->roles[0] || 'shop_manager' === $current_user->roles[0] || 'administrator' === $current_user->roles[0] || 'autonomo' === $current_user->roles[0] || 'iva' === $current_user->roles[0] || 'customer' === $current_user->roles[0] ) {
		$current_user->roles[0]='customer';
		}
				else {
			$current_user->roles[0]='guest';
				}
